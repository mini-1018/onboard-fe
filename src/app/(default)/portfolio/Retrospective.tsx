    ...
    <div className="space-y-8 w-full">
      ...
      <div className="flex flex-wrap gap-4">
        <button
          ...
          className={`px-6 py-3 rounded-lg font-semibold transition-colors flex items-center text-sm sm:text-base
            ${
              activeTab === "troubles"
      ...
      {/* Content */}
      <div className="bg-white rounded-lg p-4 md:p-8 shadow-lg min-h-[400px] shadow-primary">
        {activeTab === "troubles" && (
          <div className="space-y-6">
            <h3 className="text-lg md:text-2xl font-semibold text-primary flex items-center">
        ...
        {activeTab === "solutions" && (
          <div className="space-y-6">
            ...
            <ul className="flex flex-col xl:flex-row gap-6 list-disc list-inside text-gray-600">
              <div className="w-full xl:w-1/2 xl:border-r xl:border-gray-400 xl:pr-6">
                <li className="list-item">
                  ...
                  <div className="relative w-[90%] sm:w-[70%] md:w-[450px] h-[200px] md:h-[250px] rounded-lg ml-6 mt-4">
                    <Image
              ...
              <div className="w-full xl:w-1/2 space-y-4">
                ...
                <li className="list-item">
                  ...
                  <div className="space-y-4">
                    <p className="ml-8 mt-1 text-xs md:text-sm">

...
export default function Introduction() {
  return (
    <div className="space-y-6 w-full">
      <div className="flex flex-col sm:flex-row gap-4 sm:items-end border-b border-primary pb-6">
        <Image
                ...
                <div>
                  <div className="flex flex-col md:flex-row items-center gap-10">
                    <Image
                      ...
                      height={100}
                    />
                    <div className="text-gray-600 leading-relaxed w-[100%] md:w-[70%]">
          ...
          <div className="flex flex-col md:flex-row gap-5">
            <div className="w-full md:w-[50%] shadow-sm py-5 px-2 sm:px-10 rounded-lg shadow-primary">
              ...
              <div className="space-y-3">
                <p className="text-base md:text-lg font-bold">Site</p>
                <a
                  href="https://onbrd.kr"
                  target="_blank"
                  rel="noreferrer"
                ...
                <p className="text-base md:text-lg font-bold">Github</p>
                <a

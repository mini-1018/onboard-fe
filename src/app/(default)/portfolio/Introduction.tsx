      ...
      <div className="w-full flex gap-20">
        <div className="w-[50%]">
          <div className="h-full">
            <div className="space-y-6 h-full">
              <div className="h-full shadow-sm py-5 px-10 rounded-lg shadow-primary">
                ...
                <div className="flex items-center gap-20">
                  <Image
                    ...
                    height={100}
                  />
                  <div className="text-sm text-gray-600 leading-relaxed w-[70%]">
                    ...
                    <p>
                      ...
                      생활에서 선임자 없이 새로운 업무를 맡아 성공적으로 수행한
                      경험들은 빠른 적응력과 자기주도적 문제해결 능력을
                      키워주었습니다. 이러한 경험을 토대로 개발자에게 필요한 세
                      가지 핵심 역량을 갖추었습니다.
                    </p>
                    ...
                    <ul className="space-y-4 mt-4">
                      <li>
                        ...
                        <p>
                          - 개인 프로젝트 'OnBoard'에서 LightHouse 성능 지표
                          평균 99점을 달성했으며, 부하 테스트(VUs 1000)에서 평균
                          응답속도 2.27ms의 성능을 실현했습니다.
                        </p>
                      </li>
                    ...
                    <p className="mt-4">
                      이러한 역량들을 바탕으로 최적화된 서비스 구현과 효과적인
                      팀 커뮤니케이션, 책임감 있는 업무 수행을 통해 귀사의
                      발전에 기여하고자 합니다.
                    </p>
                  </div>
                </div>
        ...
        <div className="w-[50%] space-y-4">
          <div className="flex gap-20">
            ...
            <div className="shadow-sm py-5 px-8 rounded-lg shadow-primary w-[60%]">
          ...
          <div className="w-full p-4 px-10 bg-white rounded-lg shadow-primary space-y-4">
            <h2 className="text-3xl font-bold text-primary border-b border-primary pb-2">
              Contents
            </h2>

            <ul className="space-y-2 text-gray-700 text-lg pl-4">
              <li>1. 소개</li>
              <li>2. 기술스택</li>
              <li>3. 프로젝트 구성</li>
              <li>4. 적용 기능</li>
